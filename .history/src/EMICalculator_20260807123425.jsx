...
import { 
  FaCalculator, FaChartPie, FaHistory, FaShare, 
  FaPrint, FaDownload, FaSun, FaMoon, FaExchangeAlt,
  FaHome, FaCar, FaUniversity, FaWallet
} from 'react-icons/fa';
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        {/* ===== AD SPACE - TOP ===== */}
        <div className={`rounded-xl p-3 mb-6 text-center text-sm border-2 border-dashed ${darkMode ? 'border-gray-700 text-gray-500' : 'border-gray-300 text-gray-400'}`}>
          📢 Google Ad Space
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 sm:gap-6">
          ...
          <div className="lg:col-span-3 space-y-4">
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-2">
                    ...
                    <span className="text-xs text-gray-400 ml-auto">₹1Cr</span>
                  </div>
                </div>
            ...
            {/* ===== AD SPACE - MIDDLE ===== */}
            <div className={`rounded-xl p-3 text-center text-sm border-2 border-dashed ${darkMode ? 'border-gray-700 text-gray-500' : 'border-gray-300 text-gray-400'}`}>
              📢 Google Ad Space
            </div>
          </div>
        ...
        {/* ===== AD SPACE - BOTTOM ===== */}
        <div className={`mt-4 rounded-xl p-3 text-center text-sm border-2 border-dashed ${darkMode ? 'border-gray-700 text-gray-500' : 'border-gray-300 text-gray-400'}`}>
          📢 Google Ad Space
        </div>
